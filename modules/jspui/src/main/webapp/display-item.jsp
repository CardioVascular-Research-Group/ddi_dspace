...
<div class="panel panel-info ifShow" style="display: none;"><div class="panel-body"><a href="<%= request.getContextPath() %>/simple-search?filterquery=%2Fjspui%2Fhandle%2F<%= handle %>&filtername=refDatasets&filtertype=equals">Click here to view publications associated with this database.</a></div></div>
